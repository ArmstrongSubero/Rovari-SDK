 ...
 * standard practice, since hardware NSS is rarely used because most
 ...
 *
 * @param inst      SPI_1, SPI_2, or SPI_3
...
public:
    /**
     * Construct and initialize SPI in master mode.
    ...
    Spi(SpiInstance inst, uint32_t speed_hz = 1000000,
        ...
        : _inst(inst)
    {
        spi_init(inst, speed_hz, mode, lsb_first ? 1 : 0);
    }
