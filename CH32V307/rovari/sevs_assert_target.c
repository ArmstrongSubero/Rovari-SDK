 ...
 *
 * Part of the SEVS runtime. The runtime is Apache-2.0 so it may be
 * compiled into and distributed with end-user firmware. The wider SEVS
 * framework (standard text, checkers, methodology) is proprietary and
 * confidential, licensed separately. The Apache-2.0 grant here covers ONLY
 * this runtime file, not the SEVS framework.
 */
/**
...
#  error "SEVS_CRASH_RECORD_ADDR must be defined for your target. Set it to a valid SRAM address. Example: -DSEVS_CRASH_RECORD_ADDR=0x20003F00U (ARM) or 0x61100000U (Baochip-1x)"
#endif
