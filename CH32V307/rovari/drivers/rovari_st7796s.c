 ...
 * @brief ST7796S 480x320 RGB565 TFT driver over SPI2 + DMA.
 *
...
static void lcd_spi_init(void)
{
    ...
    /* PB14 = SPI2_MISO (configured but unused in 1-line TX mode) */
...
void lcd_set_rotation(uint8_t rotation)
{
     ...
     *   bit 3: BGR (color order). The ST7796 panel is BGR.
     */
    switch (rotation) {
