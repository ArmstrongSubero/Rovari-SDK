 ...
 *   I2C_1: SDA=PB7,  SCL=PB6   (APB1, up to 400 kHz)
 *   I2C_2: SDA=PB11, SCL=PB10  (APB1, up to 400 kHz)
 *
 * This driver implements master-mode I2C with:
 *   - Bus scanning (detect connected devices)
 *   - Byte/register read and write
 *   - Multi-byte (burst) read and write
...
/**
 * I2c — C++ wrapper for the Rovari I2C master API.
 *
 * Usage:
 *   I2c wire(I2C_1);
