 ...
 *
 * CH32V203 variant: Ports A-D only (no Port E), SERIAL1-4, SPI1-2, I2C1-2
 */
...
/* Pin encoding: port_index (0=A,1=B,2=C,3=D) in upper nibble, pin 0-15 in lower */
...
/* UART instance identifiers (SERIAL to avoid HAL macro collision) */
typedef enum {
    SERIAL1 = 1,
    SERIAL2 = 2,
    SERIAL3 = 3,
