 ...
 *
 * rovari_gpio.c - GPIO implementation wrapping WCH HAL (CH32H417)
 */
...
static const uint32_t rcc_table[] = {
    RCC_HB2Periph_GPIOA,  /* 0 */
    RCC_HB2Periph_GPIOB,  /* 1 */
    RCC_HB2Periph_GPIOC,  /* 2 */
    RCC_HB2Periph_GPIOD,  /* 3 */
    RCC_HB2Periph_GPIOE,  /* 4 */
    RCC_HB2Periph_GPIOF,  /* 5 */
};
...
static void ensure_port_clock(pin_t pin)
{
    ...
    if (!(_port_clocks_enabled & mask)) {
        RCC_HB2PeriphClockCmd(rcc_table[idx], ENABLE);
