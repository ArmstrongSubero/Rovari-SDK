 ...
 * array initializers and struct copies. These are weak so that
 * newlib-nano's versions take priority when linked with nano.specs.
 */
...
__attribute__((weak)) void *memset(void *dst, int val, size_t n)
{
    uint8_t *d = (uint8_t *)dst;
