...
static int32_t s_last_roll;
static int32_t s_last_pitch;
...
{
    uint32_t r2 = (uint32_t)((int64_t)s_last_roll * s_last_roll);
    uint32_t p2 = (uint32_t)((int64_t)s_last_pitch * s_last_pitch);
    return isqrt(r2 + p2);
}